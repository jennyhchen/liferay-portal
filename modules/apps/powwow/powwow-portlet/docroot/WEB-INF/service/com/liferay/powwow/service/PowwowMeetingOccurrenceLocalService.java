...
/**
 * Provides the local service interface for PowwowMeetingOccurrence. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Shinn Lok
 * @see PowwowMeetingOccurrenceLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PowwowMeetingOccurrenceLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PowwowMeetingOccurrenceLocalServiceUtil} to access the powwow meeting occurrence local service. Add custom service methods to <code>com.liferay.powwow.service.impl.PowwowMeetingOccurrenceLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public List<PowwowMeetingOccurrence> findByStatusAndEndTimeLE(
		OccurrenceStatus occurrenceStatus, long maxEndTime, int start, int end);
